...
var file_simple_proto_rawDesc = []byte{
	...
	0x36, 0x0a, 0x06, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x2c, 0x0a, 0x07, 0x47, 0x65, 0x74,
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x0e, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x3b, 0x55, 0x73,
...
var file_simple_proto_depIdxs = []int32{
	0, // 0: Simple.GetList:input_type -> SimpleRequest
	1, // 1: Simple.GetList:output_type -> SimpleResponse
...
type SimpleClient interface {
	GetList(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error)
}
...
func (c *simpleClient) GetList(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	out := new(SimpleResponse)
	err := c.cc.Invoke(ctx, "/Simple/GetList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleServer interface {
	GetList(context.Context, *SimpleRequest) (*SimpleResponse, error)
}
...
func (*UnimplementedSimpleServer) GetList(context.Context, *SimpleRequest) (*SimpleResponse, error) {
...
func _Simple_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimpleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServer).GetList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Simple/GetList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServer).GetList(ctx, req.(*SimpleRequest))
	}
...
var _Simple_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetList",
			Handler:    _Simple_GetList_Handler,
		},
	},
